#!/usr/bin/env python3
"""Level 2: run the notebook-style PyEPO SPO+ Warcraft reference."""
...
def build_arg_parser():
    return common.build_arg_parser(
        "Run the Level-2 Warcraft PyEPO SPO+ reference reproduction."
    )
...
def main(argv=None) -> int:
    ...
    print(f"Saved Level-2 PyEPO reference outputs to {result['output_dir']}")
