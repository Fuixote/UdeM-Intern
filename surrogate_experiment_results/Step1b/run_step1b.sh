...
E2E_EARLY_STOP_METRIC="${STEP1B_E2E_EARLY_STOP_METRIC:-}"
E2E_EARLY_STOP_PATIENCE="${STEP1B_E2E_EARLY_STOP_PATIENCE:-0}"
E2E_EARLY_STOP_MIN_DELTA="${STEP1B_E2E_EARLY_STOP_MIN_DELTA:-0.0}"
