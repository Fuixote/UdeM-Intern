"""Post-hoc Step1b diagnostics from cached trajectory and per-graph metrics."""
...
DEFAULT_RESULTS_ROOT = (
    SCRIPT_DIR
    / "remote_results"
    / "formal_M16_2stage500_e2e500_s10"
)
...
def plot_trajectory_dashboard(results_root: Path, train_size: int, out_dir: Path) -> Path:
    ...
    fig.suptitle(f"Step1b Trajectory Diagnostic Dashboard (train_size={train_size})", y=1.08, fontsize=14)
...
def parse_args(argv=None):
    parser = argparse.ArgumentParser(description="Plot Step1b post-hoc diagnostics.")
