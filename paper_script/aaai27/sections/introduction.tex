...
\begin{itemize}
    ...
    \item We provide controlled toy examples showing the same pattern in
    stable set, matching, knapsack, and matroid problems, with shortest-path and
    serial-path controls showing much larger regret.
\end{itemize}
