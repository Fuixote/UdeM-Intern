...
conditional: KEP-like packing and stable-set problems are not automatically
easy for two-stage models. When prediction noise selects many wrong local
components, or when alternatives are well separated, regret can increase and DFL
has more room to help. The evidence supports the proposed explanation, but
broader benchmarks are needed before treating Property X as a complete taxonomy
of when DFL helps.
