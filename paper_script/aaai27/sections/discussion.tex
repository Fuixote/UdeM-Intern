...
benchmark, and the toy examples are illustrative mechanisms rather than
statistical proof. The evidence supports the proposed explanation, but broader
benchmarks are needed before treating Property X as a complete taxonomy of when
DFL helps.
