    ...
    \begin{column}{0.47\textwidth}
      \begin{block}{Shortest path}
        \begin{itemize}\tightitems
          ...
          \item Standard benchmark where DFL often helps strongly.
        \end{itemize}
      \end{block}
...
\begin{frame}{Finding 1: Many Second-Best Solutions Are Still Good}
  ...
  \begin{tikzpicture}
    \begin{axis}[
      ...
      symbolic x coords={2stage r1,2stage r2,DFL r1,DFL r2},
      xtick=data,
      ...
      \addplot[fill=kepblue!35,draw=kepblue!85] coordinates {
        (2stage r1,53.14) (2stage r2,45.19) (DFL r1,59.28) (DFL r2,47.97)
      };
    \end{axis}
  \end{tikzpicture}
  \end{center}
...
\begin{frame}{Finding 2: DFL Helps by Reranking Candidate Solutions}
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.48\textwidth}
      \textbf{DFL selected ranking}
      \vspace{0.4em}

      \begin{tikzpicture}[x=1mm,y=1mm]
        \node[draw=kepgreen!70,fill=kepgreen!7,rounded corners=2pt,minimum width=50mm,minimum height=7mm,align=left,font=\scriptsize] at (27,35) {rank 1\quad B: promoted by DFL};
...
\begin{frame}{Case Evidence: G-392 Exact Correction}
  ...
  \vspace{0.35em}
  {\scriptsize Two-stage selects a high-gap solution; DFL recovers the oracle solution in this seed.}
\end{frame}
...
\begin{frame}{Case Evidence: G-1560 Near-Oracle Correction}
  ...
  \vspace{0.35em}
  {\scriptsize DFL does not exactly match oracle here, but reduces the gap from 0.2923 to 0.0120.}
\end{frame}
...
\begin{frame}{Takeaways from this Project}
  ...
  \vspace{0.6em}
  {\scriptsize Next step: tell a good story, turn this into a conference paper.}
\end{frame}
